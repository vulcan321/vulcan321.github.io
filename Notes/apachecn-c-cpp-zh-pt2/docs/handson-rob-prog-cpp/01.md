...
*   **Bonjour**: 这通常用于通过 wi-fi 将打印机连接到计算机。可以从[https://support.apple.com/kb/ DL999？viewlocale = en*MY&locale = en*MY](https://support.apple.com/kb/DL999?viewlocale=en*MY&locale=en*MY)下载。
...
6.  之后，要将 Raspberry Pi 3B 连接到特定的 wi-fi 网络，请输入`sudo nano /etc/wpa*supplicant/wpa*supplicant.conf`命令，如下图所示:
