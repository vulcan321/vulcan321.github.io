...
1.  阈值化
2.  `flip(original*image, new*image, 0)`]
3.  右下角的块
4.  `resize(original*image , resized*image , cvSize(640,480));`]
5.  在屏幕的左上角

# 第 8 章: 使用 Haar 分类器进行人脸检测和跟踪

1.  `haarcascade*frontalface*alt2.xml`].
2.  水平线特征。
3.  `haarcascade*lefteye*2splits.xml`].
4.  感兴趣的区域。
