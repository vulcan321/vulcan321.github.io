...
![How it works…](img/B04929*03*01.jpg)
...
5.  向其中添加以下代码行：
    ...
    int main()
    {
        ...
        // Push elements    
        *stack.Push("UI*Element1");
        *stack.Push("UI*Element2");
        // Size of stack
...
5.  向其添加行代码：
    ...
    void Binary*Tree::destroy*tree(node *leaf)
    {
      if (leaf != NULL)
      {
...
![How it works…](img/B04929*03*02.jpg)
...
![How it works…](img/B04929*03*03.jpg)
...
4.  向其中添加以下代码行：
    ...
    int main()
    {
      ...
      possible*paths.push*back(1);
      possible*paths.push*back(1);
      possible*paths.push*back(8);
      possible*paths.push*back(9);
      possible*paths.push*back(7);
      possible*paths.push*back(8);
      possible*paths.push*back(2);
      possible*paths.push*back(3);
      possible*paths.push*back(3);

      possible_paths.sort();
      possible_paths.unique();

      for (list<int>::iterator list*iter = possible*paths.begin();
        list*iter != possible*paths.end(); list_iter++)
      {
        cout << *list_iter << endl;
      }
...
4.  向其中添加以下代码行：
    ...
    int main()
    {
      ...
      if (score*list.find("Samuel") == score*list.end())
      {
