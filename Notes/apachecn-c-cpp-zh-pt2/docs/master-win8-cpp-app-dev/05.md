...
![Element-to-element binding](img/5022*05*01.jpg)
...
![Object-to-element binding](img/5022*05*02.jpg)
...
![Object-to-element binding](img/5022*05*03.jpg)
...
![Binding to collections](img/5022*05*04.jpg)
...
![Value converters](img/5022*05*05.jpg)
...
Object^ OnSaleToBrushConverter::Convert(Object^ value, TypeName targetType, Object^ parameter, String^ culture) {
  return (bool)value ? *onSaleBrush : *normalBrush;
}
...
![Value converters](img/5022*05*06.jpg)
...
![Value converters](img/5022*05*07.jpg)
...
![MVVM constituents](img/5022*05*08.jpg)
...
有关 MVVM 的更多信息，可以在维基百科的[http://en.wikipedia.org/wiki/Model*View*ViewModel](http://en.wikipedia.org/wiki/Model*View*ViewModel)上找到一个很好的开端。
