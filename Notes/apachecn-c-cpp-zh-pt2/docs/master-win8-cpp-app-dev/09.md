...
![The application view state](img/5022*09*04.jpg)
...
![Implementing view state changes](img/5022*09*03.jpg)
...
![Implementing view state changes](img/5022*09*05.jpg)
...
![Packaging and validating](img/5022*09*06.jpg)
...
![Packaging and validating](img/5022*09*07.jpg)

单击**下一步**会显示一个对话框，允许选择要构建(和测试)的配置：

![Packaging and validating](img/5022*09*08.jpg)
...
![Packaging and validating](img/5022*09*01.jpg)
...
![Using the Windows App Certification Kit](img/5022*09*02.jpg)
