...
![Capabilities](img/5022*08*01.jpg)
...
![Share source](img/5022*08*02.jpg)
...
![Share target](img/5022*08*05.jpg)
...
void SharePage::OnShare(Object^ sender, RoutedEventArgs^ e) {
  if(_operation->Data->Contains(StandardDataFormats::Bitmap)) {
    auto op = _operation;
    create*task(*operation->Data->GetBitmapAsync()).then(
...
![Sharing page UI generation](img/5022*08*06.jpg)
...
![FileOpenPicker contract](img/5022*08*07.jpg)
...
![Implementing a FileOpenPicker contract](img/5022*08*08.jpg)
...
![Implementing a FileOpenPicker contract](img/5022*08*09.jpg)

如果选择了 FLAGS 应用，则会显示以下内容：

![Implementing a FileOpenPicker contract](img/5022*08*10.jpg)
...
void FileOpenPickerPage::OnFlagSelected(Object^ sender, 
  ...
  if(*gridFlags->SelectedIndex < 0 && *currentFile != nullptr) {
...
![Settings extension](img/5022*08*11.jpg)
