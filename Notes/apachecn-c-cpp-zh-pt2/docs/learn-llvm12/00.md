...
![](img/B15647*Preface*table_1.1.jpg)
...
我们还提供了一个 PDF 文件，其中包含本书中使用的屏幕截图/图表的彩色图像。 您可以在此处下载：[https://static.packt-cdn.com/downloads/9781839213502*ColorImages.pdf](*ColorImages.pdf)。
