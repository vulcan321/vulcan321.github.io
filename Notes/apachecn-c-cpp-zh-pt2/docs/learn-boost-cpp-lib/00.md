...
本书中的许多代码示例都需要 C++ 11 支持，因此，您应该选择对 C++ 11 支持良好的编译器版本。您可以在[http://en.cppreference.com/w/cpp/compiler*support](http://en.cppreference.com/w/cpp/compiler*support)中找到更多详细信息。
...
```cpp
$ g++ -g listing1.cpp -o listing1 -lboost*system -lboost*coroutine -lboost*date*time -std=c++ 11
