...
有关构建系统及其提供的好处的更多信息，请访问[http://www.cs.virginia.edu/~ dww4s/articles/build*systems.html # mae](http://www.cs.virginia.edu/~dww4s/articles/build*systems.html# make)。
...
```cpp
std::vector<std::unique*ptr<Item>> m*items;
std::vector<std::unique*ptr<Enemy>> m*enemies;
```
...
![Level data](img/B04920*02*02.jpg)
...
![Inheritance](img/B04920*02*03.jpg)
...
Std::unique*ptr<Weapon> myWeapon = std::make*unique<Sword>();
```
...
![Pointers and object slicing](img/B04920*02*04.jpg)
...
![Pointers and object slicing](img/B04920*02*05.jpg)
...
![Running the project](img/B04920*02*06.jpg)
...
![Updating and drawing](img/B04920*02*07.jpg)
