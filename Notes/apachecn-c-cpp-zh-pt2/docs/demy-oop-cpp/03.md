...
![Figure 3.1 – Memory model for Chp3-Ex1.cpp](img/B15702*03*01.jpg)
...
![Figure 3.2 – Memory model for Chp3-Ex2.cpp](img/B15702*03*02.png)
...
![Figure 3.3 – Memory model for Chp3-Ex3.cpp](img/B15702*03*03.jpg)
...
![Figure 3.4 – Memory model for Chp3-Ex4.cpp](img/B15702*03*04.jpg)
...
最重要的是，您现在已经准备好进入[*第 4 章*](04.html# *idTextAnchor169)，*间接寻址-引用*，其中我们将探讨使用引用的间接寻址。一旦您了解了间接寻址的两种类型-指针和引用-并且可以轻松地操作任何一种，我们将从[*第 5 章*](05.html# *idTextAnchor199)开始，在本书中介绍面向对象的核心概念，*探究类详细*。
