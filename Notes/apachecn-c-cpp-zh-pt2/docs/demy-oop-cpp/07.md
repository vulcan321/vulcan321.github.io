...
从[*第 5 章*](05.html# *idTextAnchor199)，*详细探究类*，[*第 6 章*](06.html# *idTextAnchor262)，*实现单继承层次结构*，现在，您了解了封装，信息隐藏，概括和专业化的关键 OO 思想。您知道如何封装一个类，使用单个继承构建继承层次结构，以及构建层次结构的各种原因 (例如支持 Is-a 关系或支持实现继承的较少使用的原因)。让我们首先通过探索**多态性**来扩展我们的基本 OO 术语。
...
![Figure 7.1 – Memory model for the current example](img/Figure*7.1*B15702.jpg)
