...
```cpp
// FX1_main.cpp
// requires FX*source.cpp, FX*print.cpp
...
int main()
{
  ...
  auto result = fx*eq1.get*data*and*premium();
...
result*data FX::evaluate*data*and*premium() const
{
  double dtau, alpha, k;
...
```cpp
// FX2_main.cpp
// requires FX2*source.cpp, FX*print.cpp
...
int main()
{
  ...
  auto result = fx*eq2.get*data*and*premium();
