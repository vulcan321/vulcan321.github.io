...
![Image](..\..\images\744cbae9-7dcb-4679-a897-607fd447a22d.png)
...
![Image](..\..\images\791e62ca-7b47-4a4a-b9e6-8a020c1d53bb.png)
...
![Image](..\..\images\df856f5b-d4ee-454e-8d5c-50c6ddc297c1.png)
...
```
cog run python -m transformers.models.llama.convert*llama*weights*to*hf \
```
...
第四步来到微调模型，默认情况下，微调脚本上配置的 GPU 功能较弱，但如果你有性能更好的 GPU，则可以在 finetune.py 中将 MICRO\*BATCH\*SIZE 增加到 32 或 64。此外，如果你有指令调优数据集，则可以在 finetune.py 中编辑 DATA\*PATH 以指向自己的数据集。需要注意的是这一项操作应该确保数据格式与 alpaca\*data\_cleaned.json 相同。接下来运行微调脚本：
...
![Image](..\..\images\6266d9f1-a24c-4470-bbde-d4f9ab2bc800.png)
...
![Image](..\..\images\0c63b4bf-5daf-4897-8d3e-cdeee7448b47.png)
...
![Image](..\..\images\857abd99-c88c-4d93-aae7-7348eac1fc4e.png)

  

![Image](..\..\images\e06d8f4a-6ebc-422d-a72a-b52582ba8cb7.png)
...
![Image](..\..\images\c961cebf-509c-4ac2-b461-fa6d46361240.png)
