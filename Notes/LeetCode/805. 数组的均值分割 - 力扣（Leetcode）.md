...
我们记数组 `nums` 的和为 sss，元素个数为 nnn。子数组 AAA 的和以及个数分别为 s1s\*1s1 和 kkk，那么子数组 BBB 的和为 s2=s-s1s\*2 = s - s\_1s2\=s-s1，个数为 n-kn - kn-k，即：  
$$
\frac{s*1}{k} = \frac{s*2}{n-k} = \frac {s-s_1} {n-k}
$$
整理可得：
