### # <h2 id="cpp*11*new_keywords">C++11含义变化或者新增含义关键字</h2>
...
namespace inline_test{
    ...
    void test*inline*namespace(){
        Inlinel inl;
        inl.iv = 5;
        Inline2 in2;in2.dv = 2;
    }
}
void test*inline*namespace2(){
...
```
上述代码中test*inline*namespace处在linline*namespace1的外层，所以可以直接使用Inline1和Inline2。test*inline*namespace2处在更外层，这时也只是需要使用外层命名空间inline*test前缀即可。
