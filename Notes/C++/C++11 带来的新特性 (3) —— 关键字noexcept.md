...
```cpp
    ...
    noexcept(__and*<is*nothrow*move*assignable<_T1>,
                    is*nothrow*move*assignable<*T2>>::value)
    {
...
The result is true if the set of [*potential exceptions*](https://en.cppreference.com/w/cpp/language/except*spec) of the *expression* is empty (until C++17)*expression* is [*non-throwing*](https://en.cppreference.com/w/cpp/language/noexcept*spec) (since C++17), and false otherwise.
