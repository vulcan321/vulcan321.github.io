...
时间步$t'$之前的输出子序列$y*1, \ldots, y*{t'-1}$
...
$$ \frac{1}{L^\alpha} \log P(y*1, \ldots, y*{L}\mid \mathbf{c}) = \frac{1}{L^\alpha} \sum*{t'=1}^L \log P(y*{t'} \mid y*1, \ldots, y*{t'-1}, \mathbf{c}),$$
...
1. 在 :numref:`sec_seq2seq`的机器翻译问题中应用束搜索。
   束宽是如何影响预测的速度和结果的？
1. 在 :numref:`sec*rnn*scratch`中，我们基于用户提供的前缀，
