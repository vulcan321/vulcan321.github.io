...
`pandas` can automatically convert this column to two columns "Alley*Pave" and "Alley*nan".
A row whose alley type is "Pave" will set values of "Alley*Pave" and "Alley*nan" to 1 and 0.
