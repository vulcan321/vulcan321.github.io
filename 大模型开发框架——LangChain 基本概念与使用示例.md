...
-   LLM: 最基础的通过“**text in ➡️ text out**”模式来使用的 Language Model，另一方面，LangChain 也收录了大量的**[第三方 LLM](https://link.zhihu.com/?target=https%3A//python.langchain.com/docs/integrations/llms/)**。
-     
